...
def main():
    grid = initialize_grid() # initializes the game grid using the initialize_grid() function, creating a 4x4 grid with two randomly placed tiles of value 2.
    print("Welcome to 2048!")
    print_grid(grid)

    while True: # initiates an infinite loop, ensuring that the game continues until the player either wins or loses and the loop is explicitly broken.
        ...
        generate_new_cell(grid) # After each valid move, a new tile with a value of 2 is generated on an empty cell using the generate_new_cell(grid) function.
        print_grid(grid)
